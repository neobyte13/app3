...
String paystackPublicKey = 'pk_live_7a5961b2e8c417a51de1895d20a8e2cfbb1c80a7';
const String appName = 'Gberaa Delivery';
dynamic curUser;
...
class _PaymentPageState extends State<PaymentPage> {
  ...
  getCurUser() async {
    var curUser = await FlutterSession().get('user');
  ...
  _startAfreshCharge() async {
    ...
    if (_isLocal) {
      ...
      charge
        ...
        ..putCustomField('Charged From', curUser.toString());
      _chargeCard(charge);
    } else {
